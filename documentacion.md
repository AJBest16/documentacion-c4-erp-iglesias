...
C4Component
    ...
    Rel(security, authCtrl, "Enruta")
    Rel(security, personCtrl, "Enruta")
    Rel(security, courseCtrl, "Enruta")
    Rel(security, enrollCtrl, "Enruta")
    Rel(security, financeCtrl, "Enruta")
    Rel(security, dashCtrl, "Enruta")
    ...
    Rel(enrollCtrl, repo, "Usa")
    Rel(financeCtrl, repo, "Usa")
